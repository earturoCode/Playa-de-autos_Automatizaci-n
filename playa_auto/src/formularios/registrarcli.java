...
public class registrarcli extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        clidirecc = new javax.swing.JLabel();
        ...
        nomcli.setToolTipText("REGISTRAR CLIENTE!");

        apecli.setText("APELLIDO");
        apecli.setToolTipText("REGISTRAR CLIENTE!");

        cicli.setText("CI");
        cicli.setToolTipText("REGISTRAR CLIENTE!");

        clidirecc.setText("DIRECCION");
        clidirecc.setToolTipText("REGISTRAR CLIENTE!");

        botonagg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/playa_auto/Images/anadir-cliente.png"))); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(nomcli, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(apecli, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(cicli, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(clidirecc, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nomcli, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtnom, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(20, 20, 20)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtape, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(apecli, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(clidirecc, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtdireccKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtdireccKeyTyped
        // No hay validación adicional para dirección, pero podrías agregarla si es necesario
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(registrarcli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private boolean validateFields() {
        ...
        if (txtci.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "El CI no puede estar vacío", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if (txtdirecc.getText().trim().isEmpty()) {
    ...
    private void clear_text() {
     ...
     private void generar_codigo() 
     {
        try 
        {
            ...
            miconexion.resultado = miconexion.sentencia.executeQuery("SELECT IFNULL(MAX(cli_id),0) + 1  AS nuevocod FROM cliente");
     ...
     private void grabar_datos(){
          try { 
              ...
              if(operacion.equals("agregar")){
                   miconexion.sentencia.executeUpdate("INSERT INTO cliente(cli_id,cli_nom,cli_ape,cli_ci,cli_direcc) VALUES("+
                           this.txt_codigo.getText()+",'"+
                           this.txtnom.getText()+"','"+
                           this.txtape.getText()+"','"+
                           this.txtci.getText()+"','"+
                           this.txtdirecc.getText()+"')");
              ...
              if(operacion.equals("editar")){
                   ...
                   miconexion.sentencia.executeUpdate("UPDATE cliente SET cli_nom = '"+this.txtnom.getText()+"', cli_ape = '"+this.txtape.getText()+"', cli_ci = '"+this.txtci.getText()+"', cli_direcc = '"+this.txtdirecc.getText()+"' WHERE cli_id ="+this.txt_codigo.getText());
  ...
  private void buscar_codigo()
  {
        ...
        try 
        {
            ...
            miconexion.resultado = miconexion.sentencia.executeQuery("SELECT * FROM cliente WHERE cli_id = "+this.txt_codigo.getText());
            
            //etraer los datos de la variable
            while(miconexion.resultado.next()==true)
            {   
                this.txtnom.setText(miconexion.resultado.getString("cli_nom"));
                this.txtape.setText(miconexion.resultado.getString("cli_ape"));
                this.txtci.setText(miconexion.resultado.getString("cli_ci"));
                this.txtdirecc.setText(miconexion.resultado.getString("cli_direcc"));
            ...
            {
                JOptionPane.showMessageDialog(null, "No existe cliente con este codigo!", "Atencion", JOptionPane.ERROR_MESSAGE);
                    ...
                    if(respuesta == JOptionPane.YES_OPTION) // si
                     {
                          // habilitar 
                          miconexion.sentencia = miconexion.conexion.createStatement();
                          miconexion.sentencia.executeUpdate("DELETE FROM cliente WHERE cli_id ="+this.txt_codigo.getText());
    ...
    private javax.swing.JLabel clidirecc;
